...
Sua missão é analisar o texto do contrato público/termo de referência e extrair com precisão os dados estruturados no formato JSON estrito, sem markdown ao redor (sem \`\`\`json).
...
Retorne exatamente um objeto JSON com esta estrutura:
{
  ...
  "carencia_dias": number (padrão 15),
  ...
  "liquidacoes": [
    {
      "numero_medicao": string (ex: "1ª Medição"),
      "numero_nota_empenho": string (ex: "NE-2026/0012"),
      "data_liquidacao": string (YYYY-MM-DD),
      "valor_liquidado": number,
      "percentual_medido": number,
      "status_tramitacao": string ("Liquidado e Pago", "Liquidado", "Em liquidação"),
      "observacoes": string
    }
  ]
}`
